...
Dr. Stephen Roddy is a researcher and lecturer working at the intersection of engineering and the sonic arts, developing auditory interfaces for complex data. His work combines media engineering methods with experimental music practices to explore how sound can make opaque data infrastructures perceptually tangible. He is currently focused on sonification for distributed network environments and the ethics of artificial intelligence (AI/ML). Stephen approaches this work through the lens of [critical technical practice](https://journals.sagepub.com/doi/10.1177/13548565231192105) with a theoretical grounding in cybernetics, human-computer interaction, and embodied cognitive science. He holds a PhD in Engineering from Trinity College Dublin and lectures in the Department of Digital Humanities at University College Cork, where he is a member of the Radical Humanities Laboratory.

Stephen extends sonification, the representation of data with sound, into a critical practice for examining the operations and impacts of sociotechnical systems by listening to the data they produce. His previous projects have explored auditory display solutions for large-scale IoT networks, as well as applications of generative systems, cybernetic design principles, and AI/ML techniques in automated music synthesis. This work was carried out under an IRC Postdoctoral Fellowship at [CONNECT: the Research Ireland Centre for Future Networks and Communications](https://connectcentre.ie/), and subsequently at the Department of Electronic & Electrical Engineering at TCD. His work has been published through peer-reviewed journal publications, conference proceedings, and book chapters. He also writes for public audiences with public audiences with a recent piece on [machine listening and surveillance for The Wire](https://www.thewire.co.uk/in-writing/collateral-damage/against-the-grain-listening-after-palantir), and an interview on [sonification, 6G and the emerging Internet of Sounds with IEEE Spectrum](https://spectrum.ieee.org/data-sonification-stephen-roddy). Stephen contributed to an [IEEE Standards Authority report](https://sagroups.ieee.org/global-initiative/wp-content/uploads/sites/542/2022/07/ead-artists.pdf) on ethically aligned approaches to AI in the arts, developed under the IEEE Global Initiative on Ethics of Autonomous and Intelligent Systems.  Earlier work developed embodied sonification strategies and data-driven musical pieces exploring the [impact and fallout of Ireland's 2008 financial crash](https://stephenroddy.bandcamp.com/album/the-human-cost-a-sonification-of-irelands-economic-crash).

Stephen maintains an active artistic practice that is central to his research activity. This practice complements the conventional STEM and humanities methods applied elsewhere in his work. It also provides a practice-led context for developing and critically examining the technical systems investigated in his written work. His practice includes music composition and performance, generative and data-driven music, and sound art installation and performance. His recent musical releases, including [Leviathan](https://stephenroddy.bandcamp.com/album/leviathan), [Stardust Sonata](https://fiadh.bandcamp.com/album/stardust-sonata), and [Corpus/Mimesis](https://stephenroddy.bandcamp.com/album/corpus-mimesis), a collaboration with AMAE, Pier Giorgio De Pinto, and the late philosopher Jean-Luc Nancy, are available through [Fiadh Productions](https://fiadh.bandcamp.com/). His music has been  broadcast on international stations including RTÉ lyric fm, RTÉ Radio 1, ERT Third Programme (Greece), WFMU (New York), LYL Radio (France) and NAISA Radio (Canada). Recent performances and installations of his work have included the ElettroAQustica 10 festival in L'Aquila, the New York City Electroacoustic Music Festival, and the Earth Rising Festival at the Irish Museum of Modern Art.
...
- [Sonification is becoming a language for data — Sonic Field, 2026.](https://sonicfield.org/sonification-is-a-data-language) Feature on sonification, artificial intelligence, 6G, and computational listening.
