...
I am a Musical/Sound Artist, Researcher and Lecturer and based at the Radical Humanities Lab and the Department of Digital Humanities at University College Cork. My work spans engineering and the creative arts with a focus on musical & creative computing. I hold a Ph.D. in sonification: the use of sound to perceptualize data and convey information. My research explores the application of auditory display, artificial intelligence/machine learning (AI/ML), internet of things (IoT), and human-computer interaction (HCI) techniques in the creative arts. Primarily from the perspectives of cybernetics and embodied cognitive science.
