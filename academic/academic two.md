...
Stephen Roddy is a Researcher, and Lecturer working in computing and the arts (sound, music, digital) at the [Radical Humanities Lab](https://www.ucc.ie/en/future-humanities/radical/) and the Department of [Digital Humanities](https://www.ucc.ie/en/dah/) at [University College Cork](https://www.ucc.ie/en/). He holds a Ph.D. in sonification: the use of sound to perceptualize data and convey information. Stephen's research explores the application concepts and frameworks from the creative arts to solve technical and engineering problems across the fields of [auditory display](https://icad.org/new-to-auditory-displays/), internet of things (IoT), applied artificial intelligence/machine learning (AI/ML), [sound and music computing](https://smcnetwork.org/roadmap.html#definition) and [human-computer interaction](https://www.interaction-design.org/literature/topics/human-computer-interaction). This work involves research methods from both engineering design and the humanities, with theoretical roots in cybernetics and embodied cognitive science.
