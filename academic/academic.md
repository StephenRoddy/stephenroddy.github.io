...
Stephen Roddy is a Musician, Researcher and Lecturer working in computing and the arts (sound, music, digital) at the [Radical Humanities Lab](https://www.ucc.ie/en/future-humanities/radical/) and the Department of [Digital Humanities](https://www.ucc.ie/en/dah/) at [University College Cork](https://www.ucc.ie/en/). He has a background in [sound and music computing](https://smcnetwork.org/roadmap.html#definition) holding a Ph.D. in sonification: the use of sound to perceptualize data and convey information. Stephen's research explores the application of [auditory display methods](https://icad.org/new-to-auditory-displays/), internet of things (IoT) sensor networks, and artificial intelligence/machine learning (AI/ML) techniques, in sound and music computing contexts. This work is theoretically grounded in both embodied cognitive science and cybernetics, and adopts both engineering design and practice-based research methods.
